define([
    ...
    return Abstract.extend({
        ...
        disableFields: function () {
            ...
            registry.async(self.parentName + '.experius_postcode_fieldset.experius_postcode_postcode')(function () {

                registry.get(self.parentName + '.experius_postcode_fieldset.experius_postcode_postcode').set('visible', true);
            });
            registry.async(self.parentName + '.experius_postcode_fieldset.experius_postcode_housenumber')(function () {
                registry.get(self.parentName + '.experius_postcode_fieldset.experius_postcode_housenumber').set('visible', true);
            });

            registry.async(self.parentName + '.experius_postcode_fieldset.experius_postcode_housenumber_addition')(function () {
                if (registry.get(self.parentName + '.experius_postcode_fieldset.experius_postcode_housenumber_addition')) {
        ...
        hideFields: function () {
            ...
            registry.async(self.parentName + '.street')(function () {
            ...
            if (registry.get(this.parentName + '.experius_postcode_fieldset.experius_postcode_housenumber_addition') && additions.length > 1 && !registry.get(this.parentName + '.experius_postcode_fieldset.experius_postcode_disable').get('value')) {
                ...
                $.each(additions, function (key, addition) {
                    if (!addition) {
                        ...
                        options[key] = {
                            'label': additionStripped,
                            'labeltitle': additionStripped,
                            'value': additionStripped
                        };
                    }
                });
        ...
        formatAddress: function(overrideData) {
            ...
            var houseNoAdd = overrideData.housenumber_addition || formData.experius_postcode_housenumber_addition;
            if (registry.get(this.parentName + '.experius_postcode_fieldset.experius_postcode_housenumber_addition_manual').visible()) {
                houseNoAdd = formData.experius_postcode_housenumber_addition_manual;
            }
